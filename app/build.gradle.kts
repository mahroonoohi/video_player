...
android {
    namespace = "mahroo.noohi.videoplayer"
    compileSdk = 34

    defaultConfig {
        applicationId = "mahroo.noohi.videoplayer"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.media3:media3-exoplayer-smoothstreaming:1.3.1") // [Optional] If your media item is smoothStreaming
